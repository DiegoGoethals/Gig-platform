...
namespace Gig.Platform.Core.Interfaces.Services
{
    public interface IJobService
    {
        ...
        Task<ResultModel<Job>> UpdateAsync(Guid id, string name, string description, double salary, IEnumerable<string> skills, double latitude, double longitude, string streetName, string houseNumber, string postalCode, string city);
